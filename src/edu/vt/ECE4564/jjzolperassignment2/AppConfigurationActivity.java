...
public class AppConfigurationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setAndroidSettingsButton_.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				
				final String inputServerIP = inputServerIP_.getText().toString();
				final String inputServerPort = inputServerPort_.getText().toString();
				
				if(inputServerIP.isEmpty() || inputServerPort.isEmpty())
				{
				...
				else
				{
				    ...
				    Log.i("!", "Trying to Update Android settings");
				    boolean finished = false;
				    finished = updateAndroidServerConfiguration(inputServerIP, inputServerPort);
				    if(finished)
				    {
				    	AppConfigurationActivity.updateAndroidSettingStatus_.setText("");
	...
	public boolean updateAndroidServerConfiguration(String newServerIP, String newServerPort)
	{
	...
	public static void displaySettingsUpdateSuccessMessage()
	{
		...
		AppConfigurationActivity.updateAndroidSettingStatus_.append("The Android settings" + "\n" 
