	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PersonalSettingsButton_.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent psIntent = new Intent(MainActivity.this, PersonalSettingsActivity.class);
		...
		ConfigurationButton_.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent appconfigIntent = new Intent(MainActivity.this, AppConfigurationActivity.class);
